...
import NoStoryFound from "./NoStoryFound";

const appSetting = {
  databaseURL: "https://assignment-task-61d06-default-rtdb.firebaseio.com/",
};
...
export default function Story() {
  ...
  useEffect(() => {
    //set content when inner width is greater than 250px
    windowWidth > 250 ? setContent(true) : setContent(false);
  }, [windowWidth]);
